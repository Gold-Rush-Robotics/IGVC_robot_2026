...
setup(
    ...
    entry_points={
        'console_scripts': [
            ...
            'real_gps_waypoint_node = igvc_lane_detection.real_gps_waypoint:main',
            'nav2_gps_waypoint_node = igvc_lane_detection.nav2_gps_waypoint:main',
            'sim_gps_spoofer_node = igvc_lane_detection.sim_gps_spoofer:main',
